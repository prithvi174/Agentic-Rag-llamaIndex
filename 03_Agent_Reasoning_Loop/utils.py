...
# SET GROQ AS LLM — no OpenAI needed
Settings.llm = Groq(
    model="llama-3.1-8b-instant",
    api_key=os.environ["Groq_api_key"]  # or use os.environ["GROQ_API_KEY"]
)
...
def get_doc_tools(
    ...
    summary_tool = QueryEngineTool.from_defaults(
        ...
        description=(
            ...
            f"Always pass a query string describing what summary you need."  # ADD THIS
        ),
    )
